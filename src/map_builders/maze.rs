//! Maze map builder.
//!
//! Classic recursive-backtracker maze: start in one cell, wander to random
//! unvisited neighbors knocking down walls as you go, and backtrack whenever
//! you hit a dead end. Every cell ends up reachable through exactly one
//! path.
//!
//! Good for: claustrophobic, disorienting levels. Use sparingly - full mazes
//! are slow to explore and can wear players out.
